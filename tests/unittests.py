...
class TestPipeline(unittest.TestCase):
    def test_linear(self):
        a1 = vpl.generators.Iteration(range(6))
    ...
    def test_tree(self):
        a1 = vpl.generators.Iteration(range(70))  # First generator is intentionally larger than second one
        b1 = vpl.core.Function(lambda n: n * 3)(a1)

        a2 = vpl.generators.Iteration(["0", "1", "2", "3", "4", "5"])
    ...
    def test_filter_linear(self):
        a1 = vpl.generators.Iteration(range(10))
    ...
    def test_arg_select(self):
        ...
        a1 = vpl.generators.Iteration(range(5))
    ...
    def test_value(self):
        a1 = vpl.generators.Value(1)
        b1 = vpl.core.Function(lambda v: v + 1)(a1)
        result = b1()

        self.assertEqual(2, result)

    def test_endless_value(self):
        a1 = vpl.generators.EndlessValue(42)
        a2 = vpl.generators.Iteration(range(10))
